...
- [`traceability/CODEX_SDK_TECH_LEAD_CONTROL_PLANE_ADMISSION.md`](traceability/CODEX_SDK_TECH_LEAD_CONTROL_PLANE_ADMISSION.md) — admitted #379 Wave‑2 static/deterministic convergence subject, exact merge provenance, hosted evidence, consumed sibling publication state, and historical Wave‑2 ownership at admission; live-lane ownership has since transferred to the Wave‑3 successors recorded in `WAVE3_ADMISSION.md`.
