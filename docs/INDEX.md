...
| [`traceability/current-runtime-handoff/README.md`](traceability/current-runtime-handoff/README.md) | issue/PR terminal classifications, real-problem ledger and runtime/source handoff, each stamped with the readback date it was observed on — no gate enforces its freshness, so re-read `main` and provider state before acting |
| [`traceability/git-at-any-scale/AGENTS.md`](traceability/git-at-any-scale/AGENTS.md) | nearest rules for the Cursor Git-at-any-scale source/contract/canary/Shadow audit (#531/#532/#534/#535/#536) |
...
- [`../skills/git-town-stacked-pr-worker/molecular-indexes/codex-v2/README.md`](../skills/git-town-stacked-pr-worker/molecular-indexes/codex-v2/README.md) — terminal Molecular index for Wave-3/Codex v2, entropy, and the formerly held Draft stacks (all terminal at the 2026-08-22 readback).
- [`traceability/git-at-any-scale/README.md`](traceability/git-at-any-scale/README.md) — the one authoritative detailed Git-at-any-scale trace: source packet, 28-claim denominator, closure State Machine and evidence ceilings. Its `L1`/`S1` rows are stamped to the 2026-08-21 compile; the later canary and Shadow receipts live under [`../data/handoff/git-at-any-scale/`](../data/handoff/git-at-any-scale/) and are authority over the prose.
- [`../skills/git-town-stacked-pr-worker/molecular-indexes/git-at-any-scale/README.md`](../skills/git-town-stacked-pr-worker/molecular-indexes/git-at-any-scale/README.md) — terminal Molecular index for the Git-at-any-scale delivery topology (#531/#532/#534/#535/#536); a prose projection with no machine index behind it.
- [`../skills/git-town-stacked-pr-worker/molecular-indexes/spatial-407/README.md`](../skills/git-town-stacked-pr-worker/molecular-indexes/spatial-407/README.md) — terminal Molecular index for the Spatial Loop ICPG program (#407–#411); PR #412 is `CLOSED_UNMERGED / SUPERSEDED_BY_#419` at the 2026-08-22 readback.
...
- [`../skills/agentic-tech-lead-orchestration/README.md`](../skills/agentic-tech-lead-orchestration/README.md) — contract-first multi-branch decomposition, dual DAG, deterministic context, bounded Worker execution, tournament selection, convergence, and Local Handoff Queue handoff.
- [`../skills/agentic-tech-lead-orchestration/runtime-handoff/README.md`](../skills/agentic-tech-lead-orchestration/runtime-handoff/README.md) — Local Handoff State Machines, DAG and data flow for every queue in that directory: #508/#464 (codex-v2), #466 (herdr), #512 (source-evidence), Spatial #407/#411, and git-at-any-scale #531/#532/#534/#535/#536.
...
- [`../skills/git-hosting-scale-assurance/README.md`](../skills/git-hosting-scale-assurance/README.md) — portable Git-hosting durability/consistency/cache/recovery assurance contracts; evidence chain: the sha256-bound source packet under [`../data/handoff/source-evidence/`](../data/handoff/source-evidence/) and the claim-closure projection under [`traceability/git-at-any-scale/`](traceability/git-at-any-scale/).
- [`../skills/github-portfolio-control/README.md`](../skills/github-portfolio-control/README.md) — portfolio epoch binding, subagent-join barrier, one-shot CI and authority-composition contracts.
- [`../skills/intent-to-evidence-knowledge-graph/README.md`](../skills/intent-to-evidence-knowledge-graph/README.md) — Zettelkasten v7.2 semantic projection, canonical ICPG bridge, Tech Lead/Stack delivery trace, authority-aware evidence ceiling and GraphRAG routing contract.
...
An index fails in one direction only: a dead link is found when followed, while an omission looks exactly like completeness. `scripts/check_document_routes.py` measures the stated Skill-directory counts from the tree and refuses drift. 21 of 40 skill directories ship a `README.md` and 15 are routed above. The six that ship one and are still unrouted are `codebase-atlas`, `dual-forge-repository-loop`, `dual-track-code-review-loop`, `human-led-agentic-engineering`, `productization-operating-loop`, and `skill-refactor-proof-loop`; each belongs to its own line of work and is named so the omission cannot look complete. The remaining 19 directories have no nearest-README route to omit yet. Shared/repo-owned classification remains governed by `registry.json`.
