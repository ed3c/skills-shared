...
- [`traceability/WAVE3_REPLACEMENT_CONVERGENCE.md`](traceability/WAVE3_REPLACEMENT_CONVERGENCE.md) — current authority for #473 rejected provenance, #479 replacement convergence, current-main reconciliation, final hosted gates, and runtime evidence ceilings.
...
- [`../skills/git-town-stacked-pr-worker/README.md`](../skills/git-town-stacked-pr-worker/README.md) — Stack PR method and Molecular indexes, including admitted UCR Epic #398 plus #375–#379 and #464–#479 control-plane lineages.
