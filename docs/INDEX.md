...
- [`traceability/WAVE3_LIVE_EVIDENCE.md`](traceability/WAVE3_LIVE_EVIDENCE.md) — #464–#468 TRUE_CHILD live-evidence carriers, convergence State Machine, immutable integration checkpoint, deterministic denominator and Local Handoff Queue boundary.
...
- [`../skills/git-town-stacked-pr-worker/README.md`](../skills/git-town-stacked-pr-worker/README.md) — Stack PR method and Molecular indexes, including #375–#379 and #464–#468 multi-parent convergence.
