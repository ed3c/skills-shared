...
- [`traceability/WAVE3_LIVE_EVIDENCE.md`](traceability/WAVE3_LIVE_EVIDENCE.md) — #464–#468 live-evidence carriers, fork-time dependency graph, convergence State Machine, immutable integration checkpoint, deterministic denominator and Local Handoff Queue boundary. PR #473 is rejected provenance history; replacement convergence is PR #479.
...
- [`../skills/git-town-stacked-pr-worker/README.md`](../skills/git-town-stacked-pr-worker/README.md) — Stack PR method and Molecular indexes, including #375–#379 and #464–#468 convergence lineages.
