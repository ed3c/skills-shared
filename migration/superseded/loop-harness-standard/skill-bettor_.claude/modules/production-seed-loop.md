...
Paired B1-B8 owner、正負控制與 evidence type 以
[`dual-loop-eight-base.md`](dual-loop-eight-base.md) 和
`../data/dual-loop-eight-base.json` 為準。本節只說 production-seed extension 的分工。
...
Structure readiness, test-contract readiness, and outcome readiness require
separate receipts. A production seed may claim the first two after manifest and
adversarial selftests pass; it may not claim the third until independently
produced observations pass the declared outcome consumer.
