...
```
$ python3 /Users/neon/skill-bettor/.claude/skills/html-for-decisions/scripts/check_decision_html.py --selftest
...
$ python3 /Users/neon/skill-bettor/.claude/skills/html-for-decisions/scripts/context_trace.py --selftest
  [PASS] 去重後 2 calls / 人類 turns=1 / 工具計數 Bash=1 / 輸出 tokens=130 /
         prefix-miss 抓到 1 起 / oracle 2/2 / html 含各標記
SELFTEST PASS (exit 0)

$ python3 /Users/neon/skill-bettor/.claude/skills/html-for-decisions/scripts/check_decision_html.py \
    /Users/neon/skill-bettor/.claude/skills/html-for-decisions/reference/antigravity-example-decision-dashboard.html
