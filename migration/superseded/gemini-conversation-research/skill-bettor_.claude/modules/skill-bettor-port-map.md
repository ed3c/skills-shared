...
- Local skill copy: `/Users/neon/skill-bettor/.claude/skills/gemini-conversation-research/`
- Local small-loop template: `/Users/neon/skill-bettor/loop_wiki/evolve-unknown-discovery-plan-truth/templates/gemini-conversation-research/`
- Local plan anchor: `/Users/neon/skill-bettor/docs/plans/2026-07-22-unknown-discovery-gcr-order/01-small-loop-plan-truth-rerun.md`
...
| --- | --- | --- |
| Live Gemini browser extraction | `/Users/neon/antigravity/scripts/extract-gemini-conversation.mjs` and browser/CDP runtime | Mark packet `external_engine_required: true` until a skill-bettor-native extractor exists. |
| Gemini DR monitor/retry/extract engine | antigravity `automate.js`, `ui.js`, `data.js`, and `gemini-deep-research-extract` | Do not claim skill-bettor can run S3 end-to-end unless those engines are installed or mirrored. |
...
1. A local artifact exists under `/Users/neon/skill-bettor`.
