...
sys.path.insert(0, "/Users/neon/antigravity")
...
MD = "/Users/neon/antigravity/gemini_research/gcr/loop-evals-autoprompt-qa-session.md"
GRAPH = os.environ.get("ANTIGRAVITY_GRAPH_PATH", "/Users/neon/antigravity/.cache/kg/graph.json")
