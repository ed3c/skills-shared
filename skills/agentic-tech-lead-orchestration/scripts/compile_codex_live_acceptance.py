...
def compile_receipt(data:dict[str,Any])->dict[str,Any]:
    ...
    rw={"task_id","attempt_id","repo","base_sha","tree_sha","prompt_digest","adapter_state","sdk_execution","controller_readback_required","lease_readback","changed_files","turn_status"}
    ...
    return {"schema_version":1,"task_id":w["task_id"],"attempt_id":w["attempt_id"],"repo":w["repo"],"base_sha":w["base_sha"],"tree_sha":w["tree_sha"],"prompt_digest":w["prompt_digest"],"worker_result_sha256":_digest(w),"changed_files":wp,"controller_commands":c["commands"],"sdk_execution":"EXERCISED","lease_readback":"PASS","source_diff_readback":"PASS","tests_readback":"PASS","acceptance_state":"LIVE_RUNTIME_AND_CONTROLLER_READBACK_CANDIDATE","shadow_review_required":True,"evidence_ceiling":"LIVE_EXECUTION_OBSERVED_SHADOW_PENDING"}
