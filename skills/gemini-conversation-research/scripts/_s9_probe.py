...
def nid(n):
    return n.get("id", "") if isinstance(n, dict) else ""
...
hits = [
    ...
    and ("notebooklm" in nid(n).lower() or "badf3207" in nid(n).lower())
]
...
print(
    "total lib: nodes =",
    sum(1 for n in nodes if isinstance(n, dict) and nid(n).startswith("lib:")),
)
