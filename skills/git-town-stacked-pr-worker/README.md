...
14. [`../../docs/traceability/TECH_LEAD_SHADOW_CLOSURE.md`](../../docs/traceability/TECH_LEAD_SHADOW_CLOSURE.md) for Tech Lead/Shadow closure and external consumer snapshots.
...
A historical node records exact head/merge/rollback identity and proven ceiling.
It cannot become the current queue, branch writer, or live evidence source by age
or documentation reuse.
...
Observed `2026-08-17`. This section is `EXTERNAL_CONSUMER_SNAPSHOT`, not
`ed3c/bettor-arena` state authority. Refresh the consumer's current issue/PR
metadata, exact GitHub/local/Forgejo subjects, machine Stack index and Local
Handoff Queue before acting.
...
These are not Git children of #172 because they do not consume #172's unmerged
bytes. Live Git Town, physical Workers, live carriers/providers, Human admission,
release and rollback remain separate evidence/authority lanes.

Full role, State Machine, data-flow and evidence-ceiling details:
