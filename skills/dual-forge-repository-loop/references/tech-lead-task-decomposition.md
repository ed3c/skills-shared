...
The Tech Lead does not spawn arbitrary Agents or execute provider commands through this reference. `scripts/compile_tech_lead_plan.py` compiles a plan into deterministic Worker packets. A consumer runtime decides how to allocate actual Workers after validating the packets.
