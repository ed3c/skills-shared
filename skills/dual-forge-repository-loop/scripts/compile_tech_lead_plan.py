...
SCHEMA = "dual-forge-repository-loop/tech-lead-plan/v1"
RECEIPT_SCHEMA = "dual-forge-repository-loop/tech-lead-compile-receipt/v1"
PACKET_SCHEMA = "dual-forge-repository-loop/task-packet/v2"
